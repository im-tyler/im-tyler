...
| [multipurpose-tool](https://github.com/im-tyler/multipurpose-tool) | Agent-facing base tooling — one installable CLI for standard file conversions and desktop operations, built for the Tebian desktop play. Concept stage. |
